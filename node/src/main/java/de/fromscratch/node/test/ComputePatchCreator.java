...
//			
//			Node startNode = (Node)getNodeFromMap(nodes, line.split(Pattern.quote(" "))[0].split(Pattern.quote("."))[0]);
//			Node endNode   = (Node)getNodeFromMap(nodes, line.split(Pattern.quote(" "))[1].split(Pattern.quote("."))[0]);
//			
